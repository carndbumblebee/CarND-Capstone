...
class TLDetector(object):
    ...
    def get_closest_waypoint(self, x,y):
        ...
        for idx, waypoint in enumerate(self.waypoints):
            dist = self.distance_between_two_points([x,y], waypoint.pose.pose.position)
    ...
    def process_traffic_lights(self):
        ...
        for light_idx, stop_line in enumerate(stop_line_positions):
            ...
            if line_idx > car_idx and abs(line_idx-car_idx) < DIST_FORWARD_VISIBILE and abs(line_idx-car_idx) < min_dist:
        ...
        if light:
            ...
            # rospy.loginfo('~~:Close Traffic Light. light_wp: {}'.format(light_wp))
